...
<html>
    <head>
        ...
        <link href="<c:url value="/assets/css/HomePageCSS/homepage.css"/>" rel="stylesheet" type="text/css">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                                <div class="target">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Cam kết mức giá tiết kiệm nhất, rẻ nhất, phù hợp và hợp lý nhất thị trường</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                                <div class="target">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Chấp nhận thanh toán bằng cả hình thức trực tiếp lẫn chuyển khoản hay các phương thức liên kết</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                                <div class="target">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Dễ dàng, nhanh chóng trong vòng 30s, được tận tâm chăm sóc, hỗ trợ nhiệt tình, hiếu khách</p>
                                    </div>
                                </div>
                            </div>
